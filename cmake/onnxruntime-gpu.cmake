...
if (LINUX)
    set(ORT_DOWNLOAD_URL "https://github.com/microsoft/onnxruntime/releases/download/v1.19.2/onnxruntime-linux-x64-gpu-1.19.2.tgz")
    string(REGEX MATCH "([^/]+)\\.tgz$" ORT_FILE_NAME ${ORT_DOWNLOAD_URL})
    string(REGEX REPLACE "\\.tgz$" "" ORT_FILE_BASE_NAME ${ORT_FILE_NAME})
elseif (WIN32 OR WIN64)
    set(ORT_DOWNLOAD_URL "https://github.com/microsoft/onnxruntime/releases/download/v1.19.2/onnxruntime-win-x64-gpu-1.19.2.zip")
