...
namespace domain::face::detector {
    ...
    Yolo::preProcess(const cv::Mat& visionFrame, const cv::Size& faceDetectorSize) {
        ...
        cv::Mat tempVisionFrame = foundation::media::vision::resize_frame(visionFrame, faceDetectorSize);
    ...
    DetectionResults Yolo::detect(const cv::Mat& visionFrame) {
        ...
        const std::vector<int64_t> inputImgShape{1, 3, faceDetectorSize_.height, faceDetectorSize_.width};
