...
export namespace domain::face::helper {
    ...
    std::vector<int>
    apply_nms(const std::vector<cv::Rect2f>& boxes, std::vector<float> confidences, float nms_thresh);
    ...
    cv::Mat
    paste_back(const cv::Mat& temp_vision_frame, const cv::Mat& crop_vision_frame,
