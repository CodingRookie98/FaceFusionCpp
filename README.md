...
[[中文文档]](https://github.com/CodingRookie98/faceFusionCpp/blob/master/README_CN.md)
...
- **🛠 Comprehensive Toolset**:
  - **Face Swapping**: Swap faces in images and videos with high fidelity.
  - **Face Enhancement**: Restore and sharpen facial details.
  - **Expression Restoration**: Recover original facial expressions.
  - **Super Resolution**: Upscale low-resolution images and videos.
...
| **CUDA** | ≥ 12.2 | 12.8.1 | Required for GPU acceleration |
...
- **[Getting Started](docs/user/en/getting_started.md)**: Installation and first run.
- **[User Guide](docs/user/en/user_guide.md)**: Detailed usage instructions.
- **[CLI Reference](docs/user/en/cli_reference.md)**: Complete command-line interface documentation.
