...
FaceDetectorScrfd::FaceDetectorScrfd(const std::shared_ptr<Ort::Env> &env, const std::string &modelPath) :
...
FaceDetectorScrfd::Result
FaceDetectorScrfd::detectFaces(const cv::Mat &visionFrame, const cv::Size &faceDetectorSize,
...
FaceDetectorScrfd::preProcess(const cv::Mat &visionFrame, const cv::Size &faceDetectorSize) {
