...
export const SplitSlider: React.FC<SplitSliderProps> = ({
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full h-full select-none overflow-hidden rounded-lg bg-slate-950 flex items-center justify-center border border-white/10"
    >
      ...
      <div className="absolute inset-0 w-full h-full flex items-center justify-center">
        ...
        <div className="absolute top-3 right-3 bg-emerald-950/80 text-emerald-300 border border-emerald-500/40 text-xs px-2 py-0.5 rounded font-mono font-medium shadow-md backdrop-blur-sm">
          处理后 (AFTER)
        </div>
      </div>
      ...
      >
        ...
        <div className="absolute top-3 left-3 bg-blue-950/80 text-blue-300 border border-blue-500/40 text-xs px-2 py-0.5 rounded font-mono font-medium shadow-md backdrop-blur-sm">
          处理前 (BEFORE)
        </div>
      </div>
