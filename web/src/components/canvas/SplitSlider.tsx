...
export const SplitSlider: React.FC<SplitSliderProps> = ({
  ...
  return (
    <div className="relative max-h-full max-w-full flex items-center justify-center">
      <div
        ref={containerRef}
        className="relative inline-flex max-h-[calc(100vh-220px)] max-w-full select-none overflow-hidden rounded-lg bg-black/50 shadow-2xl items-center justify-center border border-white/10"
      >
        ...
        <div className="relative flex items-center justify-center">
          {isVideo ? (
            <video
              ...
              className="max-h-[calc(100vh-220px)] max-w-full object-contain block pointer-events-auto"
            />
          ) : (
            <img
              src={resultUrl}
              alt="Processed"
              className="max-h-[calc(100vh-220px)] max-w-full object-contain block"
            />
          )}
