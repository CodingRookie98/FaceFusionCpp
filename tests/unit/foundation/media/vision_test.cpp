...
TEST(VisionTest, CreateTileFramesSimple) {
    ...
    // Input 100x100.
    // Tile width: 50.
    // The implementation adds padding such that pad_size = size[2] + tile_width - (rows % tile_width)
    // For 100%50 == 0, pad = 0 + 50 = 50.
    // Total size becomes 150x150.
    // Loops run for 0, 50, 100.
    // Total 3x3 = 9 tiles.
